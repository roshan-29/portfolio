  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-300 to-slate-900 py-4 bg-clip-text text-center text-4xl font-black leading-12 tracking-wider text-transparent md:text-7xl"
      >
        Code with Character <br /> React with Clarity
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md -z-10", // changed to bg-black
        className
      )}
    >
...
LampContainer.propTypes = {
  ...
  className: PropTypes.string, // Validate className (optional)
};

LampContainer.defaultProps = {
  className: "", // Set default value for className
};
