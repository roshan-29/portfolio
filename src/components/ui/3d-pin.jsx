...
import { Link } from "react-router-dom"; // Use Link from React Router if needed

// Helper function for transformations
const getTransform = (hovered) => {
  return hovered
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          style={{
            transform: getTransform(hovered),
          }}
...
export const PinPerspective = ({ title, href, hovered }) => {
  return (
    <motion.div
